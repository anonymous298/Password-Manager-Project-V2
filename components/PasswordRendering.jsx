...
const PasswordRendering = ({setWebsiteURL, setUsername, setPassword, isloading}) => {
  ...
  return (
    <div className='flex flex-col gap-2'>
        ...
        {passwordObj[0] && 
            <div className='h-[250px] max-h-[300px] overflow-y-auto overflow-x-auto max-[780px]:h-[100%] max-[780px]:max-h-[100%] max-[780px]:overflow-y-visible max-[780px]:overflow-x-visible max-[780px]:flex max-[780px]:justify-center max-[780px]:items-center'>
                <table className='w-[100%] g-2'>
                    <thead className='max-[780px]:hidden'>
                        ...
                        {passwordObj.map((val, idx) => {
                            ...
                            return (
                                <motion.tr
                                    ...
                                    className="bg-[#4A9782] text-center max-[780px]:flex max-[780px]:flex-col max-[780px]:rounded-[15px] max-[780px]:gap-y-1 max-[780px]:my-2"
                                >

                                {/* // <tr className='bg-[#4A9782] text-center' key={idx}> */}
                                    <td className='p-2 '>
                                        <div className='flex justify-center items-center gap-x-2 cursor-pointer '>
                                            <p className=' min-[780px]:hidden text-black font-bold text-[17px]'>Site URL: </p>

                                            {val.websiteURL} 

                                            <button onClick={() => copyToClipboard(val.websiteURL, "WebsiteURL")}>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 hover:fill-[#DCD0A8] transition-all cursor-pointer max-[780px]:fill-blue-800">
                                    ...
                                    <td className='p-2 '>
                                        <div className='flex justify-center items-center gap-x-2 cursor-pointer'>
                                            <p className=' min-[780px]:hidden text-black font-bold text-[17px]'>Username: </p>
                                    ...
                                    <td className='p-2 '>
                                        <div className='flex justify-center items-center gap-x-2 cursor-pointer'>
                                            <p className=' min-[780px]:hidden text-black font-bold text-[17px]'>Password: </p>
                                    ...
                                    <td className='p-2 flex gap-3 justify-center items-center max-[780px]:mt-5 max-[780px]:border-t-3 border-gray-300'>
                                        {/* <p className='text-black font-bold text-[17px]'>: </p> */}

                                        <button className='cursor-pointer' onClick={() => updatePassword(val, idx)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:fill-yellow-500 max-[780px]:fill-yellow-500">
                                        ...
                                        <button className='cursor-pointer' onClick={() => deletePassword(val, idx)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:fill-red-500 max-[780px]:fill-red-500">
